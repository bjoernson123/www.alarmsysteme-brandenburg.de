      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4">1. Datenschutz auf einen Blick</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4">2. Hosting</h2>
            <div className="mb-8">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">E-Mail: info@alarmsysteme-brandenburg.de</p>
              <p className="mb-4">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4">5. Ihre Rechte</h2>
            <div className="mb-8">
